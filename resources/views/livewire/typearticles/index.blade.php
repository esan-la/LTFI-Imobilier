            ...
            <div class="card">
                <div class="card-header bg-gradient-primary align-items-center">
                    ...
                    <div class="card-tools d-flex align-items-center">
                        <a class="btn btn-link text-white mr-4 d-block" wire:click.prevent = "toggleShowAddTypeArticleForm"><i class="far fa-list-plus"></i> Nouveau type d'article</a>
                ...
                <div class="card-body table-responsive p-0 table-striped" style="height: 300px;">
                    <table class="table table-head-fixed text-nowrap">
                        <thead>
                            <tr>
                                <th style="width: 50%;">Type d'articles</th>
                        ...
                        <tbody>
                            ...
                            @if ($isAddTypeArticle)
                                <tr>
                                    <td colspan="2">
                                        <input type="text" wire:keydown.enter="addTypeArticle" class="form-control" wire:model = "newTypeArticleName" @error('newTypeArticleName') is-invalid @enderror/>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-link" wire:click.prevent="editTypeArticle(' {{ $typearticle->id }} ')"><i class="far fa-edit"></i></button>
                                    <button class="btn btn-link" wire:click="confirmDelete('{{$typearticle->nom}}', {{$typearticle->id}})"><i class="fas fa-trash-alt"></i></button>
                                </td>
                            </tr>
